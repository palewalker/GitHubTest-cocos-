...
bool HelloWorld::createBox2dWorld(bool debug)
{
    ...
    b2RevoluteJointDef tRevJointDef;
    b2WeldJointDef tWeldJointDef;
    
    body1 = this->addNewSprite(Point(100, winSize.height / 2), Size(60, 60),
                               b2_dynamicBody, "test", 0);
    body2 = this->addNewSprite(Point(100 + 2, winSize.height / 2 + 2), Size(40, 40),
                               b2_dynamicBody, "CloseNormal.png", 0);
    
    
    
    //Create RevoluteJoint
    tRevJointDef.Initialize(body1, body2, body1->GetPosition());
    _world->CreateJoint(&tRevJointDef);
    
    
    
    
    body3 = this->addNewSprite(Point(200, winSize.height / 2), Size(60, 60),
                               b2_dynamicBody, "test", 0);
    body4 = this->addNewSprite(Point(200 + 2, winSize.height / 2 + 2), Size(40, 40),
                               b2_dynamicBody, "CloseNormal.png", 0);
    ...
    _world->CreateJoint(&tWeldJointDef);
