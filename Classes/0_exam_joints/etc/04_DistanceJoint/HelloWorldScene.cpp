...
bool HelloWorld::init()
{
    ...
    auto tlblTitle = Label::createWithSystemFont("DistanceJoint", "arial.ttf",14);
...
bool HelloWorld::createBox2dWorld(bool debug)
{
    ...
    b2DistanceJointDef tDef;
    
    b2Body *body1 = this->addNewSprite(Point(240, 280), Size(40, 40), b2_dynamicBody, "test", 0);
    b2Body *body2 = this->addNewSprite(Point(340, 280), Size(40, 40), b2_dynamicBody, "test", 0);
