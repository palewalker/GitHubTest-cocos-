...
bool HelloWorld::init()
{
    ...
    auto tlblTitle = Label::createWithSystemFont("RopeJoint", "arial.ttf",14);
...
bool HelloWorld::createBox2dWorld(bool debug)
{
    ...
    b2Body *body1 = this->addNewSprite(Point(240, 280), Size(40, 40),
                                       b2_dynamicBody, "test", 0);
    
    b2Body *body2 = this->addNewSprite(Point(340, 280), Size(40, 40),
                                       b2_dynamicBody, "test", 0);
    
    tDef.bodyA = body1;
    tDef.bodyB = body2;
    tDef.localAnchorA = b2Vec2(1.0f, 0.0f);
    tDef.localAnchorB = b2Vec2(-1.0f, 0.0f);
    tDef.maxLength = 1.5;    // 0.5  2.5  5.5
