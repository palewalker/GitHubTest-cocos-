...
bool HelloWorld::createBox2dWorld(bool debug)
{
    ...
    // 바디를 생성해서 월드에 추가한다.
    b2Body* body1 = this->addNewSprite(Point(240, 160), Size(32, 32), b2_staticBody, "test", 0);
    
    b2Body* body2 = this->addNewSprite(Point(140, 160), Size(32, 32), b2_dynamicBody, "test", 0);
    
    
    b2RevoluteJointDef tDef;
    b2RevoluteJoint *tRevoluteJoint = NULL;
    ...
    tRevoluteJoint = (b2RevoluteJoint *)_world->CreateJoint(&tDef);
